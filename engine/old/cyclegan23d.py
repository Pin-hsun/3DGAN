...
class GAN(BaseModel):
    def __init__(self, hparams, train_loader, test_loader, checkpoints):
        ...
        args.bysubject = True
        args.cropsize = 128
        args.direction = 'zyori128_zyorisb128'
...
# CUDA_VISIBLE_DEVICES=0 python train.py --jsn wnwp3d --prj wnwp3d/cyc23dwo/o2o --engine cyclegan23d --input_nc 2 --output_nc 1 --direction zyori_zyori%xyori_xyori
# CUDA_VISIBLE_DEVICES=1 python train.py --jsn wnwp3d --prj wnwp3d/cyc23dwo/sb2sb --engine cyclegan23d --input_nc 2 --output_nc 1 --direction zyori_zyorisb%xyori_xyorisb