...
class GAN(BaseModel):
    ...
    def __init__(self, hparams, train_loader, test_loader, checkpoints):
        ...
        from models.genre.generator.Unet_base import SPADEUNet2
        ...
        self.net_gXY = SPADEUNet2(opt=opt, in_channels=1, out_channels=1)
        self.net_gYX = SPADEUNet2(opt=opt, in_channels=1, out_channels=1)
    ...
    def generation(self):
        ...
        self.imgXY = self.net_gXY(self.oriXo, self.oriXw)[0]
