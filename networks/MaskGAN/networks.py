...
class GlobalGenerator(nn.Module):
    def __init__(self, input_nc, output_nc, ngf=64, n_downsampling=3, n_blocks=9, norm_layer=nn.BatchNorm2d,
        ...
        # style encoder
        self.enc_style = StyleEncoder(5, 3, 16, self.get_num_adain_params(self.model), norm='none', activ='relu',
                                      pad_type='reflect')
        # label encoder
...
if __name__ == '__main__':
    g = GlobalGenerator(input_nc=1, output_nc=1, ngf=64, n_downsampling=2, n_blocks=1, norm_layer=nn.BatchNorm2d,
                        padding_type='reflect')

    fea1, fea2 = g.enc_label(torch.rand(1, 19, 256, 256))
    adain_params = g.enc_style((torch.rand(1, 3, 256, 256), fea1, fea2))