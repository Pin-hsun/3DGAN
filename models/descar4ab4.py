...
class GAN(BaseModel):
    ...
    def test_method(net_g, img, args, a=None):
        ...
        combinedXX = imgYX#combine(imgYX, oriY, method='mul')
    ...
    def generation(self, batch):
        ...
        self.oriY0 = batch['img'][2]

        self.imgXY = nn.Sigmoid()(self.net_g(self.oriX, a=None)['out0'])  # mask
        self.imgYY = self.net_g(self.oriY0, a=None)['out1']  # mask

        self.imgXY = combine(self.imgXY, self.oriX, method='mul')
        #self.imgYY = combine(self.imgYY, self.oriY0, method='mul')
    ...
    def backward_g(self):
        ...
        if self.hparams.lbx > 0:
            loss_l1x = self.add_loss_l1(a=self.imgYY, b=self.oriY)
    ...
    def backward_d(self):
        ...
        loss_da = axy * 0.5 + ay * 0.25 + ayy * 0.25
        # classify x (+) vs y (-)
        #loss_dc = cxy
        loss_d = loss_da
